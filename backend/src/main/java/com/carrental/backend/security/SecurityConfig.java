    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.PATCH, "/api/users/*").hasAnyRole("EMPLOYEE", "ADMIN")
                        .requestMatchers(org.springframework.http.HttpMethod.PATCH, "/api/reservations/*").hasAnyRole("EMPLOYEE", "ADMIN")
